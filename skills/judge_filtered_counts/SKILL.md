---
name: judge_filtered_counts
description: Judge the result of load_filtered_counts with the shared local pass/warn/fail contract.
version: 0.1.0
---
...
## Purpose
Evaluate the output of `load_filtered_counts` and return a structured judge result.
