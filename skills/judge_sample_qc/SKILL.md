---
name: judge_sample_qc
description: Judge the result of sample_qc_triage with the shared local pass/warn/fail contract.
version: 0.1.0
---
...
## Purpose
Evaluate the output of `sample_qc_triage` and return a structured judge result.
