---
name: judge_doublets
description: Judge the result of detect_doublets with the shared local pass/warn/fail contract.
version: 0.1.0
---
...
## Purpose
Evaluate the output of `detect_doublets` and return a structured judge result.
