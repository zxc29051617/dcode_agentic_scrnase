---
name: judge_preprocess
description: Judge the result of normalize_hvg_prepare with the shared local pass/warn/fail contract.
version: 0.1.0
---
...
## Purpose
Evaluate the output of `normalize_hvg_prepare` and return a structured judge result.
