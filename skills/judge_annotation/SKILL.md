...
description: Judge the result of annotate_cells with the shared local pass/warn/fail contract.
version: 0.1.0
---
...
## Purpose
Evaluate the output of `annotate_cells` and return a structured judge result.
