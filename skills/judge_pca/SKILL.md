---
name: judge_pca
description: Judge the result of run_pca with the shared local pass/warn/fail contract.
version: 0.1.0
---
...
## Purpose
Evaluate the output of `run_pca` and return a structured judge result.
