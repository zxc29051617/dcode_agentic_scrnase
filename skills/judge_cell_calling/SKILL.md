---
name: judge_cell_calling
description: Judge the result of cell_calling_review with the shared local pass/warn/fail contract.
version: 0.1.0
---
...
## Purpose
Evaluate the output of `cell_calling_review` and return a structured judge result.
