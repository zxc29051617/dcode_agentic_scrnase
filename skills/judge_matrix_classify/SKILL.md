---
name: judge_matrix_classify
description: Judge the result of count_matrix_classify with the shared local pass/warn/fail contract.
version: 0.1.0
---
...
## Purpose
Evaluate the output of `count_matrix_classify` and return a structured judge result.
