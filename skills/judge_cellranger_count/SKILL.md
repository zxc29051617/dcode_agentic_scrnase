---
name: judge_cellranger_count
description: Judge the result of cellranger_count with the shared local pass/warn/fail contract.
version: 0.1.0
---
...
## Purpose
Evaluate the output of `cellranger_count` and return a structured judge result.
