---
name: judge_ingest
description: Judge the result of ingest_validate with the shared local pass/warn/fail contract.
version: 0.1.0
---
...
## Purpose
Evaluate the output of `ingest_validate` and return a structured judge result.
