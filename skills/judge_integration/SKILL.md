...
description: Judge the result of run_integration with the shared local pass/warn/fail contract.
version: 0.1.0
---
...
## Purpose
Evaluate the output of `run_integration` and return a structured judge result.
