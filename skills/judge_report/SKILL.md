---
name: judge_report
description: Judge the result of build_report with the shared local pass/warn/fail contract.
version: 0.1.0
---
...
## Purpose
Evaluate the output of `build_report` and return a structured judge result.
